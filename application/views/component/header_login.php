...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url()?>vendors/Admin/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page" style="background-color:#fed136;">