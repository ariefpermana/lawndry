    ...
    <br>
      <div class="container">
        ...
        <div class="row text-center">
          ...
          <div class="col-md-5">
              <input class="form-control" type="text" name="jenis_layanan" value="SATUAN" disabled>
              <?php echo form_hidden('jenis_layanan','Satuan') ?>
          </div>
        </div>
        <br>
        <div class="row text-center">
      ...
      <div style="text-align:center;">
        <button class="btn btn-warning" type="submit" name="submit" value="cart">Add To Cart</button> 
